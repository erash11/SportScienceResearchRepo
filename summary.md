...
All internal papers were sourced from the Baylor Applied Performance Google Drive. The local `SourcePapers/` corpus contains 2,155 PDFs representing 2,125 unique file contents. After the July 21, 2026 cleanup and the first four reviewed pilot batches, the library contains 454 canonical rows: 445 distinct local source PDFs, eight Baylor internal documents, and one DOI-backed external paper. By file content, 441 unique local sources are represented and 1,684 remain unrepresented. The pilot has published 47 full-text-reviewed papers and excluded one mislabeled source.
...
2. Full-text screen Batch 05 from the replenished 96-paper queue in `docs/pilot-expansion-shortlist.md`
